...
function updateDashbord(BaseUrl) {
 ...
 $('#LogMessage').empty();
 getDashBordInfo();
 setInterval(getDashBordInfo, 60000 * IntervalRefresh);
}
...
function formatDisplay(val) {
 ...
 if (message == "") {
  message = "<p class='text-info' >" + gettime() + ' : ' + val + "<p>";
 }
 return message;
}
...
function GetServiceInfo(url) {
 ...
 $.ajax({
  ...
  error: function(data, errorThrown) {
   ...
   $('#Servicelog').empty();
   $('#Servicelog').append("<p class='text-danger'>" + 'ServiceInfo Health Check service not avilable!' + '</p>');
   $("#CallTime").text(gettime());
  }
 });
 ScrollDown();
...
function GetDeviceInfo(url) {
 ...
 $.ajax({
  ...
  error: function(data, errorThrown) {
   ...
   $('#HDlog').empty();
   $('#HDlog').append("<p class='text-danger'>" + 'DeviceInfo Health Check service not avilable!' + '</p>');
   $("#CallTime").text(gettime());
  }
 });
 ScrollDown();
...
function GetIISInfo(url) {
 ...
 $.ajax({
  ...
  success: function(data) {
   ...
   if ((!data.IISStatusResult.Status)) {
    $('#IISStatusClass').removeClass('bg-success').addClass('bg-danger');
   }
   $("#CallTime").text(gettime());
  },
  complete: function(data) {
  ...
  error: function(data, errorThrown) {
   ...
   $('#IISLog').empty();
   $('#IISLog').append("<p class='text-danger'>" + 'IIS Health Check service not avilable!' + '</p>');
   $("#CallTime").text(gettime());
  }
 });
 ScrollDown();
...
function GetPerformanceInfo(url) {
 ...
 $.ajax({
  ...
  error: function(data, errorThrown) {
   ...
   $('#CPUlog').empty();
   $('#CPUlog').append("<p class='text-danger'>" + 'PerformanceInfo Health Check service not avilable!' + '</p>');
   $("#CallTime").text(gettime());
  }
 });
 ScrollDown();
...
function GetRadiusInfo(url) {
 ...
 $.ajax({
  ...
  error: function(data, errorThrown) {
   ...
   $('#Radiuslog').empty();
   $('#Radiuslog').append("<p class='text-danger'>" + 'RadiusInfo Health Check service not avilable!' + '</p>');
   $("#CallTime").text(gettime());
  }
 });
 ScrollDown();
...
function GetPortInfo(url) {
 ...
 $.ajax({
  ...
  error: function(data, errorThrown) {
   ...
   $('#Portlog').empty();
   $('#Portlog').append("<p class='text-danger'>" + 'Port Health Check service not avilable!' + '</p>');
   $("#CallTime").text(gettime());
  }
 });
...
function GetDBInfo(url) {
 ...
 $.ajax({
  ...
  error: function(data, errorThrown) {
   ...
   $('#DBlog').empty();
   $('#DBlog').append("<p class='text-danger'>" + 'Database Health Check service not avilable!' + '</p>');
   $("#CallTime").text(gettime());
  }
 });
 ScrollDown();
...
function GetMySQLnfo(url) {
 ...
 $.ajax({
  ...
  error: function(data, errorThrown) {
   ...
   $('#MySQLlog').empty();
   $('#DBlog').append("<p class='text-danger'>" + 'My SQL Health Check service not avilable!' + '</p>');
   $("#CallTime").text(gettime());
  }
 });
 ScrollDown();
